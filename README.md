...
`pptx-pro-max` y `deck-studio` requieren dependencias (Node + `pptxgenjs`, Python + `python-pptx`; `deck-studio` además Playwright/Chromium para el render). Cada carpeta lo detalla en su propio `README.md`.
